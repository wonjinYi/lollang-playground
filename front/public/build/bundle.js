...
var app = (function () {
    ...
    // (10:4) <SvelteTooltip tip="Put your *.lo Code below. And press the green <RUN> button to run it" bottom>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(10:4) <SvelteTooltip tip=\\\"Put your *.lo Code below. And press the green <RUN> button to run it\\\" bottom>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea0, /*$code*/ ctx[3]);
    			...
    			set_input_value(textarea1, /*$result*/ ctx[5]);
    			current = true;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $isError,
    		...
    		$$subscribe_isError = () => ($$unsubscribe_isError(), $$unsubscribe_isError = subscribe(isError, $$value => $$invalidate(4, $isError = $$value)), isError);

    	let $result,
    		$$unsubscribe_result = noop,
    		$$subscribe_result = () => ($$unsubscribe_result(), $$unsubscribe_result = subscribe(result, $$value => $$invalidate(5, $result = $$value)), result);
    ...
    // (54:3) <SvelteTooltip tip="LEARN" bottom>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 56, 5, 2060);
    			...
    			add_location(button, file, 54, 4, 1886);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(54:3) <SvelteTooltip tip=\\\"LEARN\\\" bottom>",
    		ctx
    	});
    ...
    // (60:3) <SvelteTooltip tip="DOWNLOAD CODE" bottom>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "material-icons");
    			add_location(span, file, 61, 5, 2299);
    			attr_dev(button, "class", "header-functions-btn svelte-irkaq9");
    			attr_dev(button, "alt", "download code to your computer");
    			add_location(button, file, 60, 4, 2194);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, span);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*downloadCode*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(60:3) <SvelteTooltip tip=\\\"DOWNLOAD CODE\\\" bottom>",
    		ctx
    	});
    ...
    // (65:3) <SvelteTooltip tip="RUN CODE" bottom>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*runCode*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(65:3) <SvelteTooltip tip=\\\"RUN CODE\\\" bottom>",
    		ctx
    	});
