...
var app = (function () {
    ...
    const file$2 = "node_modules\\svelte-tooltip\\src\\SvelteTooltip.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 83, 6, 1459);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 72, 2, 1281);
    			...
    			add_location(div0, file$2, 75, 2, 1334);
    			attr_dev(div1, "class", "tooltip-wrapper svelte-16glvw6");
    			add_location(div1, file$2, 71, 0, 1249);
    		},
    ...
    function enableTextareaTab(e, textarea) {
        e.preventDefault();
    ...
    // (13:4) <SvelteTooltip tip="Put your *.lo Code below. And press the green <RUN> button to run it" bottom>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "CODE";
    			attr_dev(h2, "class", "main-subtitle svelte-li7zi1");
    			add_location(h2, file$1, 13, 8, 432);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:4) <SvelteTooltip tip=\\\"Put your *.lo Code below. And press the green <RUN> button to run it\\\" bottom>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea0, "class", "code-editor svelte-li7zi1");
    			attr_dev(textarea0, "placeholder", "code your lol here");
    			attr_dev(textarea0, "spellcheck", "false");
    			add_location(textarea0, file$1, 17, 8, 533);
    			attr_dev(div0, "class", "main-article svelte-li7zi1");
    			add_location(div0, file$1, 16, 4, 497);
    			attr_dev(section0, "class", "main-input-part svelte-li7zi1");
    			add_location(section0, file$1, 11, 0, 286);
    			set_style(div1, "border-right", "2px solid var(--gray-strong)");
    			add_location(div1, file$1, 25, 0, 772);
    			attr_dev(h2, "class", "main-subtitle svelte-li7zi1");
    			add_location(h2, file$1, 28, 4, 879);
    			attr_dev(textarea1, "class", "result-viewer svelte-li7zi1");
    			attr_dev(textarea1, "spellcheck", "false");
    			textarea1.readOnly = true;
    			toggle_class(textarea1, "errorMsg", /*$isError*/ ctx[5]);
    			add_location(textarea1, file$1, 31, 8, 964);
    			attr_dev(div2, "class", "main-article svelte-li7zi1");
    			add_location(div2, file$1, 30, 4, 928);
    			attr_dev(section1, "class", "main-output-part svelte-li7zi1");
    			add_location(section1, file$1, 27, 0, 839);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea0, /*$code*/ ctx[4]);
    			/*textarea0_binding*/ ctx[9](textarea0);
    			...
    			set_input_value(textarea1, /*$result*/ ctx[6]);
    			current = true;

    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea0, "keydown", /*keydown_handler*/ ctx[7], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let $isError,
    		...
    		$$subscribe_isError = () => ($$unsubscribe_isError(), $$unsubscribe_isError = subscribe(isError, $$value => $$invalidate(5, $isError = $$value)), isError);

    	let $result,
    		$$unsubscribe_result = noop,
    		$$subscribe_result = () => ($$unsubscribe_result(), $$unsubscribe_result = subscribe(result, $$value => $$invalidate(6, $result = $$value)), result);
    	...
    	const keydown_handler = e => e.keyCode === 9 && enableTextareaTab(e, codeEditor);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('result' in $$props) $$subscribe_result($$invalidate(1, result = $$props.result));
    		if ('isError' in $$props) $$subscribe_isError($$invalidate(2, isError = $$props.isError));
    		if ('codeEditor' in $$props) $$invalidate(3, codeEditor = $$props.codeEditor);
    	};
    ...
    // (75:3) <SvelteTooltip tip="LEARN" bottom>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 77, 5, 2949);
    			attr_dev(button, "class", "header-functions-btn svelte-irkaq9");
    			attr_dev(button, "alt", "learning materials in lollang github repository");
    			add_location(button, file, 75, 4, 2775);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(75:3) <SvelteTooltip tip=\\\"LEARN\\\" bottom>",
    		ctx
    	});
    ...
    // (81:3) <SvelteTooltip tip="DOWNLOAD CODE" bottom>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "material-icons");
    			add_location(span, file, 82, 5, 3188);
    			attr_dev(button, "class", "header-functions-btn svelte-irkaq9");
    			attr_dev(button, "alt", "download code to your computer");
    			add_location(button, file, 81, 4, 3083);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, span);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:3) <SvelteTooltip tip=\\\"DOWNLOAD CODE\\\" bottom>",
    		ctx
    	});
    ...
    // (86:3) <SvelteTooltip tip="RUN CODE" bottom>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "material-icons");
    			add_location(span, file, 87, 5, 3400);
    			attr_dev(button, "class", "header-functions-btn runbtn svelte-irkaq9");
    			attr_dev(button, "alt", "run code");
    			add_location(button, file, 86, 4, 3315);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, span);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(86:3) <SvelteTooltip tip=\\\"RUN CODE\\\" bottom>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-irkaq9");
    			add_location(img, file, 70, 2, 2584);
    			attr_dev(h1, "class", "header-title svelte-irkaq9");
    			add_location(h1, file, 71, 2, 2619);
    			attr_dev(div0, "class", "header-functions");
    			set_style(div0, "margin-left", "8px");
    			add_location(div0, file, 73, 2, 2675);
    			attr_dev(button0, "class", "header-functions-btn svelte-irkaq9");
    			add_location(button0, file, 93, 3, 3568);
    			attr_dev(button1, "class", "header-functions-btn svelte-irkaq9");
    			add_location(button1, file, 97, 3, 3716);
    			attr_dev(div1, "class", "header-lollang-github");
    			set_style(div1, "margin-left", "auto");
    			add_location(div1, file, 92, 2, 3502);
    			attr_dev(header, "class", "svelte-irkaq9");
    			add_location(header, file, 69, 1, 2572);
    			attr_dev(main, "class", "svelte-irkaq9");
    			add_location(main, file, 104, 1, 3902);
    			attr_dev(div2, "id", "app");
    			attr_dev(div2, "class", "svelte-irkaq9");
    			add_location(div2, file, 68, 0, 2555);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const runCode = async function (e) {
    		try {
    			...
    			if ($code.includes('리쉬')) {
    				throw "컴파일 모드에서는 '리쉬좀'을 사용할 수 없습니다.\n'캐리좀'을 통해 직접 값을 할당해주세요.\n";
    			}
    	...
    	const downloadCode = function (e) {
    		...
    		FileSaver_min.saveAs(blob, `lollangCode_${getCurrentTime()}.lo`);
    	};
